...
namespace StudioLE.Core.System
{
	...
	public static class GuidHelpers
    {
		...
		public static Guid FromLowerNoDashString(string value) =>
			TryFromLowerNoDashString(value) ?? throw new FormatException("The string '{0}' is not a no-dash lowercase GUID.".FormatInvariant(value));
        ...
        private static string FormatInvariant(this string format, params object?[] args) => string.Format(CultureInfo.InvariantCulture, format, args);
	}
}
