...
/// <summary>
/// Methods to help with NUnit
/// </summary>
internal static class NUnitHelpers
{
    internal static Model GetModelOrThrow(ITest test)
    {
    ...
    internal static Result<Model> TryGetModelProperty(object fixture, Type type)
    {
    ...
    internal static Result<Model> TryGetModelField(object fixture, Type type)
    {
    ...
    internal static string CreateSummary(ITest test, TestContext.ResultAdapter results)
    {
