...
namespace StudioLE.Workflows.NUnit.Execution;
...
public sealed class NUnitActivity : IActivity<object, object>, IActivityMetadata
{
    ...
    {
        // Before invocation
        bool wasVerifyEnabled = Verify.Verify.IsEnabled;
        Verify.Verify.IsEnabled = false;
        ...
        Verify.Verify.IsEnabled = wasVerifyEnabled;
